...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[50rem] md:h-[65rem] flex items-center justify-center relative p-2 md:p-16"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border border-white/10 p-2 md:p-6 bg-white/5 backdrop-blur-[12px] rounded-[2.5rem] shadow-2xl"
    >
