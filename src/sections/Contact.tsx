          ...
          <div>
            ...
            <div className="contact-anim mt-12 space-y-8">
              ...
              <div className="flex items-center gap-4 transition-transform duration-200 ease-[var(--ease-out)] hover:translate-x-1">
                ...
                <div>
                  <p className="text-xs text-zinc-400 font-light">Phone</p>
                  <a href={`tel:${siteConfig.phoneHref}`} className="text-zinc-900 font-medium hover:text-emerald-600 transition-colors duration-200">
                    {siteConfig.phone}
                  </a>
                </div>
              </div>
