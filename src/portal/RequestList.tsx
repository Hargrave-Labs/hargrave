  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between gap-4">
        ...
        <button onClick={() => navigate('/portal/new')} className={PRIMARY_BTN}>New request</button>
      </div>
      ...
      {!loading && !error && requests.length === 0 && (
        <div className="rounded-2xl border border-dashed border-white/15 bg-white/[0.02] py-16 text-center">
          ...
          <button onClick={() => navigate('/portal/new')} className={`${PRIMARY_BTN} mt-5`}>
